...
<body>
    ...
    <div class="container" id="header">
        <div class="row text-center" id="MyFoto">
            <div class="col">
        ...
        <div class="copyright">Image source <a
            ...
            <div class="col allcard">
                ...
                <div class="card" style="width: 18rem;">
                    <a href="https://stimik.herokuapp.com/">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Web Design- Stimik Indonesia Festivals</h5>
                            <p class="card-text">Landing web design with ocean theme by using
                                HTML,CSS,Bootsrap,Javascript and Jquery</p>
                ...
                <div class="card" style="width: 18rem;">
                    <a href="https://greenfoot.org/scenarios/25077">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A simple shooting game using Java with greenfoot's app</p>
                ...
                <div class="card" style="width: 18rem;">
                    <a href="https://batubusuak.wordpress.com/">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">A website that provide information of Batu Busuk destination Tourism by
